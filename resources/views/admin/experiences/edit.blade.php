...
@section('content')
<div class="admin-experience-edit-page">
    <!-- Breadcrumb -->
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Modifier l'Expérience</h1>
            <p class="page-subtitle">Modifiez les informations de cette expérience professionnelle</p>
        </div>
    ...
    <div class="form-container">
        ...
        <div class="meta-card">
            ...
            <div class="meta-content">
                <div class="meta-item">
                    ...
                    <span class="meta-value">{{ $experience->created_at->format('d/m/Y à H:i') }}</span>
                </div>
                @if($experience->updated_at != $experience->created_at)
                    <div class="meta-item">
                        <span class="meta-label">Dernière modification :</span>
                        <span class="meta-value">{{ $experience->updated_at->format('d/m/Y à H:i') }}</span>
                    </div>
                @endif
            </div>
        </div>
        ...
        <!-- Main Form -->
        <div class="form-card">
            <form action="{{ route('admin.experiences.update', $experience) }}" method="POST" id="experienceForm">
                @csrf
                @method('PUT')
            ...
            <form id="delete-form" action="{{ route('admin.experiences.destroy', $experience) }}" method="POST" style="display: none;">
                @csrf
                @method('DELETE')
            </form>
        </div>
...
function confirmDelete() {
    if (confirm('⚠️ Êtes-vous sûr de vouloir supprimer cette expérience ?\n\nCette action est irréversible.')) {
