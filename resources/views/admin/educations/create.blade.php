...
@section('content')
<div class="admin-education-create-page">
    <!-- Breadcrumb -->
    ...
    <div class="page-header">
        <div>
            ...
            <p class="page-subtitle">Ajoutez une nouvelle formation académique ou certification</p>
        </div>
    ...
    <div class="form-container">
        ...
        <div class="info-card">
            ...
            <div class="info-content">
                <h3 class="info-title">💡 Conseils pour une formation complète</h3>
                <p class="info-text">Mentionnez les matières principales étudiées, les projets académiques réalisés, et les compétences clés développées durant cette formation.</p>
            </div>
        </div>
...
Exemples:
• Formation spécialisée en développement logiciel et systèmes informatiques
• Projets: Développement d'une application de gestion, Base de données MySQL
• Compétences: Java, Python, SQL, Architecture logicielle"
                            required
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text">
                            Emoji pour représenter cette formation. Exemples :
                            <span class="emoji-examples">
                                <span class="emoji-option" data-emoji="🎓">🎓 Diplôme</span>
                                <span class="emoji-option" data-emoji="📚">📚 Études</span>
                                <span class="emoji-option" data-emoji="🔬">🔬 Sciences</span>
                                <span class="emoji-option" data-emoji="💻">💻 Informatique</span>
                                <span class="emoji-option" data-emoji="🎨">🎨 Arts</span>
                                <span class="emoji-option" data-emoji="⚕️">⚕️ Médecine</span>
                                <span class="emoji-option" data-emoji="📐">📐 Ingénierie</span>
                                <span class="emoji-option" data-emoji="🏛️">🏛️ Université</span>
                            </span>
                        </small>
                        @error('icon')
                            <span class="invalid-feedback">{{ $message }}</span>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Gestion de l'icône avec aperçu en temps réel
    ...
    emojiOptions.forEach(option => {
        option.addEventListener('click', function() {
            ...
            // Highlight visuel
            emojiOptions.forEach(opt => opt.style.background = 'rgba(99, 102, 241, 0.1)');
